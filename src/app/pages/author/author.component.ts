...
import constList from '../search/constList';

@Component({
  selector: 'author',
  templateUrl: './author.component.html',
  styleUrls: ['./author.component.scss', '../search/search.component.scss'],
  ...
  getAuhtors = () => {
    ...
    this.authorService
      ...
      .subscribe((data: { [x: string]: any }) => {
        this.authorList = data['data'].map((user: any) => {
