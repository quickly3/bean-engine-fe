...
export class SearchComponent {
  ...
  updateQueryParamsByUrl(): void {
    ...
    if (urlParamsCopy['startDate']) {
      urlParamsCopy['startDate'] = this.strToNgbDate(
        urlParamsCopy['startDate']
      );
    }
    ...
    if (urlParamsCopy['subNavModel']) {
      ...
      const curSubNav = this.subNavItems.find(
        (i) => i.name === urlParamsCopy['subNavModel']
      );

      if (curSubNav) {
        this.curSubNav = curSubNav;
      }
    }
  ...
  ngbDateToStr = (ngbDate: any): string => {
    if (!ngbDate) {
      return '';
    }
  ...
  setQueryParamsToUrl(queryStringParams: any): void {
  ...
  searchCharts = (option = { updateSta: true }) => {
    ...
    this.searchService
      .getArticleHistogram(queryStringParams)
      .subscribe((resp: { [x: string]: any }) => {
  ...
  searchCloudWords = (option = { updateSta: true }) => {
    ...
    this.setQueryParamsToUrl(queryStringParams);
    this.searchService
      .getWordsCloudByQueryBuilder(queryStringParams)
      .subscribe((resp: { [x: string]: any }) => {
  ...
  searchAuthorAggs = (option = { updateSta: true }) => {
    ...
    this.setQueryParamsToUrl(queryStringParams);
    this.searchService
      .getAuthorTermsAgg(queryStringParams)
      .subscribe((resp: any) => {
        this.authorAggs = resp.data.map((d: any) => ({
          name: d.key,
          value: d.doc_count,
        }));
      });
  ...
  searchTagsAggs = (option = { updateSta: true }) => {
    ...
    this.setQueryParamsToUrl(queryStringParams);
    this.searchService
      .getTagsTermsAgg(queryStringParams)
      .subscribe((resp: any) => {
        this.tagsAggs = resp.data.map((d: any) => ({
          name: d.key,
          value: d.doc_count,
        }));
      });
  ...
  searchCatesAggs = (option = { updateSta: true }) => {
    ...
    this.setQueryParamsToUrl(queryStringParams);
    this.searchService
      .getCatesTermsAgg(queryStringParams)
      .subscribe((resp: any) => {
        this.catesAggs = resp.data.map((d: any) => ({
          name: d.key,
          value: d.doc_count,
        }));
      });
  ...
  searchArticles = (option = { updateSta: true }) => {
    ...
    this.setQueryParamsToUrl(queryStringParams);
    this.searchService
      .getDailyList(queryStringParams)
  ...
  searchDatasSimple = (term: any) => {
    ...
    return this.searchService.searchDatasSimple(params).pipe(
      map((response: any) => {
  ...
  countModified = ($event: any, field: any) => {
  ...
  clickCloudText = (cloudText: any): any => {
  ...
  clickHorizontalBarForTags = (i: any): any => {
    if (this.tagsAggs[i]) {
  ...
  clickHorizontalBarForCates = (i: any): any => {
    if (this.catesAggs[i]) {
