...
export default class WordCloudComponent implements OnInit {
  ...
  WordCloud = (
    words: any,
    {
      ...
      word = (d: any) => d.key, // Given an item of the data array, returns the word
    ...
    const cloud = d3Cloud()
      ...
      .rotate(rotate)
      .font(fontFamily)
      .fontSize((d) => Math.sqrt(d.size || 1) * fontScale)
      .on('word', (d: any) => {
